      ...
      <div class="screen__content">
        <form class="login" id="login-form" @submit.prevent="login">
          <div class="login__field">
            ...
            <input type="email" class="login__input" id="username" placeholder="User Email" v-model="email">
          </div>
          <div class="login__field">
            <i class="login__icon fas fa-lock"></i>
            <input type="password" class="login__input" id="password" placeholder="Password" v-model="password">
          </div>
